      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          for (int i = 0; i < sensor_fusion.size(); i++) {
            ...
            int check_lane;
            if (check_d >= 0 && check_d < 4) check_lane = 0;
            else if (check_d >= 4 && check_d < 8) check_lane = 1;
            else if (check_d >= 8 && check_d <= 12) check_lane = 2;
            else continue;
            ...
            if (check_lane == lane) {
              ...
              left_close |= (abs(car_s - check_s) < proposed_gap);
            }
          }
